 ...
 * 描述：
 */
public class TransmissionTypeAdapter  extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new MyViewHolder(inflater.inflate(R.layout.item_transmission_type, parent, false));
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (EMPTY_VIEW == itemViewType) {
            ...
            holder1.tvTransmissionType.setText(list.get(position).getValue());
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder {
        View itemView;
        private final TextView tvTransmissionType;
        private final LinearLayout card_view;

        public MyViewHolder(View itemView) {
            super(itemView);
            this.itemView = itemView;
            tvTransmissionType = itemView.findViewById(R.id.tvTransmissionType);
