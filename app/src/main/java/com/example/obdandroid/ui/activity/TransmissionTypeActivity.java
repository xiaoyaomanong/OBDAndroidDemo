...
import com.example.obdandroid.ui.adapter.TransmissionTypeAdapter;
 ...
 * 描述：
 */
public class TransmissionTypeActivity extends BaseActivity {
    private Context context;
    private RecyclerView recycleFuelType;
    private TransmissionTypeAdapter adapter;
    ...
    public void initView() {
        ...
        adapter = new TransmissionTypeAdapter(context);
        getVocationalDictDataListByType(getToken(), "变速箱类型", "transmission_type");
        adapter.setClickCallBack(entity -> {
            Intent intent = new Intent();
            intent.putExtra("transmissionType", entity);
            setResult(98, intent);
            finish();
        });
