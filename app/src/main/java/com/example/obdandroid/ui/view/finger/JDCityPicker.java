...
public class JDCityPicker extends PopupWindow {
    ...
    private void init(Context context) {
        ...
        int height = (int) (wm.getDefaultDisplay().getHeight() * 0.5);
        ...
        String data =  JsonParserUtil.getJson(context, "city.json");
        ...
        mTvProvince.setOnClickListener(v -> {
            province = "";
            city = "";
...
//                initCity();
    ...
    private void initProvince() {
        ...
        mProvinceAdapter.setOnItemListener((position, name) -> {
    ...
    private void initCity() {
        ...
        mCityAdapter.setOnItemListener((position, name) -> {
    ...
    private void initArea() {
        ...
        mAreaAdapter.setOnItemListener((position, name) -> {
