...
public class CarModelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<CarModelEntity.DataEntity> list;
    ...
    public void setList(List<CarModelEntity.DataEntity> list) {
        this.list = list;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new MyViewHolder(inflater.inflate(R.layout.item_car_model, parent, false));
    }
    ...
    public interface OnClickCallBack {
        void Click(CarModelEntity.DataEntity entity);
    }
}