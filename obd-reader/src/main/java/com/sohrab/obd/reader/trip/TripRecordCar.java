    ...
    public void updateTrip(String name, ObdCommand command) {
        switch (name) {
            ...
            case MAF:
                ...
                data.add(new OBDTripEntity("空气质量流量", mMassAirFlow + ""));
            ...
            case ENGINE_RUNTIME:
                ...
                data.add(new OBDTripEntity("引擎运行时间", TextUtils.isEmpty(engineRuntime) ? "" : engineRuntime));
            ...
            case ENGINE_COOLANT_TEMP:
                ...
                data.add(new OBDTripEntity("发动机冷却液温度", TextUtils.isEmpty(mEngineCoolantTemp) ? "" : mEngineCoolantTemp + " ℃"));
            ...
            case TIMING_ADVANCE:
                ...
                data.add(new OBDTripEntity("定时提前", TextUtils.isEmpty(mTimingAdvance) ? "" : mTimingAdvance));
            ...
            case FUEL_RAIL_PRESSURE:
                ...
                data.add(new OBDTripEntity("燃油分供管压力", TextUtils.isEmpty(mFuelRailPressure) ? "" : mFuelRailPressure));
            ...
            case FUEL_RAIL_PRESSURE_manifold:
                ...
                data.add(new OBDTripEntity("相对于歧管真空的燃油分供管压力", TextUtils.isEmpty(mFuelRailPressurevacuum) ? "" : mFuelRailPressurevacuum));
            ...
            case DISTANCE_TRAVELED_MIL_ON:
                ...
                data.add(new OBDTripEntity("MIL开时行驶的距离", TextUtils.isEmpty(mDistanceTraveledMilOn) ? "" : mDistanceTraveledMilOn));
